...
require('lazy').setup({
...

  {
    ...
    commit = "96f3682ea890a3f2037aafa253c92d0dd3b82161",
      ...
      vim.keymap.set("v", "<leader>9v", function()
        _99.visual({ additional_prompt = "Finish implementing the selected code snippet" })
      end)
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader><leader>', function()
        cleanup_git_buffers()
        builtin.buffers()
      end, { desc = '[ ] Find existing buffers (after Git cleanup)' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          require('utils.lsp_on_attach').apply(event.buf, client)
        end,
      })
  ...
  -- Keep the current function/class context visible at the top
  {
